...
//extension of task14
let din_guests:string[]=["Rizwan","Sarwan","Faizan"];
...
let message15:string=" , You are cordially invited to our family dinner! Please give us a chance to enjoy your presence in our dinner thanks";
...
for (let i = 0; i < din_guests.length; i++) {
