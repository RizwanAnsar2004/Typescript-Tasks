...
let places18_1: string[] = places18.map((word) => word.toLowerCase());
let final_places_18: string[] = places18_1.map((word) => {
...
console.log(
  "Sorting original list in reverse alphabetical orders: \n" +
    places18.reverse()
);
